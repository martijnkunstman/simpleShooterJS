import Player from "../../../classes/GameElement/Player.js"
export default class Map {
    ...
    constructor(scale: number = 0.35, width: number = 500, height: number = 500, lineWidth: number = 1, lineColor: string = "#000000") {
        this.scale = scale;
        this.x = 0;
        this.y = 0;
        this.playerX = 0;
